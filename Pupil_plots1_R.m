   ...
   for s = 1:length(sub)
      ...
      for e = 1:length(sub(s).ex)
         ...
         if ~isempty(sub(s).ex(e).d)
            ...
            subplot(4,2,jc(e) )
            plot(nanmean(sub(s).ex(e).d(1).t_m),nanmean(sub(s).ex(e).d(1).pa_m2),'b-');
            plot(nanmean(sub(s).ex(e).d(2).t_m),nanmean(sub(s).ex(e).d(2).pa_m2),'r-');
            plot(nanmean(sub(s).ex(e).d(3).t_m),nanmean(sub(s).ex(e).d(3).pa_m2),'g-');
            ...
            if sub(s).con == 0
               ...
               for d = 1:3
                  ...
                  en(e).d(d).pa(en(e).i,:) = pix2mm2(nanmean(sub(s).ex(e).d(d).pa_m2));
                  [  en(e).d(d).max_constrict(   en(e).i ), ...
                     ...
                     pix2mm2(nanmean(sub(s).ex(e).d(d).pa_m2))  );
               end %for d
            elseif sub(s).con == 1
               ey(e).i = ey(e).i + 1;
               for d = 1:3
                  ey(e).d(d).t( ey(e).i,:) = nanmean(sub(s).ex(e).d(d).t_m         );
                  ey(e).d(d).pa(ey(e).i,:) = pix2mm2(nanmean(sub(s).ex(e).d(d).pa_m2) );
...
table_exportR = array2table(ex_table)
writecell(table_exportR.ex_table1.stats, 'R_table.csv')
