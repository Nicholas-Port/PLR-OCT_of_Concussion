function [max_constrict, t_max_constrict, max_con_vel, t_max_con_vel, ...
   max_dil_vel,t_max_dil_vel, T75_time, avg_con_vel,avg_dil_vel,min_constrict ] = pupil_dynamics4(t,a)
...
% Check to see if there is no data.  If nothing, report all NaNs
if all(isnan(t)) % && isnan(a)
   max_constrict   = NaN;
   t_max_constrict = NaN;
   max_con_vel     = NaN;
   t_max_con_vel   = NaN;
